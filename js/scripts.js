    ...
    entries.forEach((entry) => {
      {
        ...
        if (entry.isIntersecting) {
          ...
          if (entry.target === $products) {
            ...
            d.querySelector(".products .section-title").classList.add(
              "is-active"
            );
          }
          if (entry.target === $testimonials) {
            ...
            d.querySelector(".testimonials .section-title").classList.add(
              "is-active"
            );
          }
          if (entry.target === $contact) {
            ...
            d.querySelector(".contact .section-title").classList.add(
              "is-active"
            );
          }
        } else {
          if (entry.target === $about) {
            d.querySelector(".about .section-title").classList.remove(
              "is-active"
            );
            $headerLink[0].classList.remove("is-active");
          }
          if (entry.target === $products) {
            d.querySelector(".products .section-title").classList.remove(
              "is-active"
            );
            $headerLink[1].classList.remove("is-active");
          }
          if (entry.target === $testimonials) {
            d.querySelector(".testimonials .section-title").classList.remove(
              "is-active"
            );
            $headerLink[2].classList.remove("is-active");
          }
          if (entry.target === $contact) {
            d.querySelector(".contact .section-title").classList.remove(
              "is-active"
            );
